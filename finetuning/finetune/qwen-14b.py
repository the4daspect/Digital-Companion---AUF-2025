...
# Set model details
model_name_for_finetuning = "unsloth/Qwen3-14B-unsloth-bnb-4bit"
max_seq_length = 2048

# WandB project details
wandb_project_name = "qwen3-finetuning"
...
save_directory = "trained_models/qwen3"
model.save_pretrained(save_directory)
tokenizer.save_pretrained(save_directory)

# Optional: Merge and save the final 16-bit model
model.save_pretrained_merged(
    "trained_models/qwen3-14b-finetuned-16bit",
    tokenizer,
