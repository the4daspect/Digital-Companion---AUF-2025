...
parser = argparse.ArgumentParser(description="Finetune gpt-oss-20b.")
parser.add_argument("--data_path", type=str, required=True)
parser.add_argument("--output_dir", type=str, required=True)
args = parser.parse_args()

# Set model details
model_name_for_finetuning = "unsloth/gpt-oss-20b"
max_seq_length = 2048

# WandB project details
wandb_project_name = "gpt-oss-20b-finetuning"
...
save_directory = "trained_models/gpt-oss-20b-instruct"
...
model.save_pretrained_merged(
    "trained_models/gpt-oss-20b-instruct-finetuned-16bit",
    tokenizer,
